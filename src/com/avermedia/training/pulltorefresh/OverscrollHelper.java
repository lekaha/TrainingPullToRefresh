...
public final class OverscrollHelper {
	 ...
	 */
	public static void overScrollBy(final IPullToRefresh<?> view, final int deltaX, final int scrollX,
	 ...
	 *            touch event, passed through from from overScrollBy call
	 */
	public static void overScrollBy(final IPullToRefresh<?> pullView, final int deltaX, final int scrollX,
		...
		PullToRefreshBase<?> view = null;
		if(pullView instanceof PullToRefreshBase){
			view = (PullToRefreshBase<?>) pullView;
		}
		else {
			return;
		}
