...
public abstract class ActionBarPullToRefreshAdapterViewBase<T extends AbsListView> extends ActionBarPullToRefreshBase<T> implements
		OnScrollListener {
	...
	public ActionBarPullToRefreshAdapterViewBase(Context context) {
		super(context);
		mRefreshableView.setOnScrollListener(this);
	}

	public ActionBarPullToRefreshAdapterViewBase(Context context, AttributeSet attrs) {
		super(context, attrs);
		mRefreshableView.setOnScrollListener(this);
	}
	...
	protected void addViewInternal(View child, ViewGroup.LayoutParams params) {
		super.addViewInternal(child, params);
	}
